...
static const OptionID kOptionModifierMapForMetaLeft = OPTION_CODE("MMML");
static const OptionID kOptionModifierMapForMetaRight = OPTION_CODE("MMMR");
static const OptionID kOptionModifierMapForSuperLeft = OPTION_CODE("MMSL");
static const OptionID kOptionModifierMapForSuperRight = OPTION_CODE("MMSR");
